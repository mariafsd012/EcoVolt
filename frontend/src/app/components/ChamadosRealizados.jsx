...
const SITUACAO_ESTILO = {
  ...
  aprovada: { background: "#dbe8d1", texto: "#3a6b35", label: "Resolvido - Aprovado" },
  aprovado: { background: "#dbe8d1", texto: "#3a6b35", label: "Resolvido - Aprovado" },
  rejeitada: { background: "#f6dedd", texto: "#b05a55", label: "Resolvido - Reprovado" },
  rejeitado: { background: "#f6dedd", texto: "#b05a55", label: "Resolvido - Reprovado" },
};
