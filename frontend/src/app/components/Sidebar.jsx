...
const subMenus = {
  "/ponto": [
    ...
    {
      href: "/ponto/ferias-folgas",
      icon: Palmtree,
      label: "Férias e Folgas",
    },
    {
      href: "/ponto/relatorio",
      icon: BarChart2,
      label: "Relatório",
    },
  ],
...
export default function Sidebar() {
  ...
  const [activeSection, setActiveSection] = useState(
    pathname.startsWith("/ponto") ? "/ponto" : null
  );
    ...
    <div className="flex h-screen bg-[#f8faf7] p-4 gap-4">
            ...
            return (
              <button
                ...
                className={`
                  ...
                  flex items-center
                  rounded-xl
                  transition-[opacity,width,color] duration-300 ease-in-out
      ...
      <aside
        className={`
          ...
          overflow-hidden
        ${subItems.length ? "w-[210px] opacity-100" : "w-0 opacity-0"}        `}
      >
        <div
          className="
            h-[82px]
